...
function evolve_media() {
  ...
  wp_enqueue_style( 'iecss', WP_CONTENT_URL . '/themes/evolve/library/media/css/ie.css' );}  
...
function evolve_copy() {
	...
	$credits = '<p id="copyright" style="margin-top:20px;"><span class="credits" style="float:right;"><a href="http://theme4press.com/evolve/">EvoLve</a> theme by Theme4Press - modified by <a href="http://greglondon.info" target="_blank">Greg London</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;Powered by <a href="http://wordpress.org">WordPress</a></span> <a href="'. home_url() .'">'. get_bloginfo( 'name' ) .'</a><br /><small>'. get_bloginfo( 'description' ) .'</small></p>';
